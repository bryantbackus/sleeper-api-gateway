...
function registerAuthTool(server, sessionId) {
   ...
   * Register the authenticate tool with the server. The callback function authenticates the user and registers the authenticated tools.
...
//Authentication tool registration w/o authenticated tools registration
function registerAuthToolNoToolRegistration(server, sessionId) {
  /**
   * Register the authenticate tool
   * @param {Object} server - The server object
   * @param {string} sessionId - The session ID
...
export { registerAuthTool, registerAuthToolNoToolRegistration }